# lets do various experimentation, to understand this code better.
import cv2
import numpy as np
...
# Load Keras Model
model = load_model('blink/eye.h5', compile=False)        #? what if 'True', nothing happened.
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        for (ex, ey, ew, eh) in eyes:
            ...
            if probability_open > 0.5:                     #? Tried changing it, nothing significant happened
                eye_status = "Open"
            else:
                eye_status = "Closed"
